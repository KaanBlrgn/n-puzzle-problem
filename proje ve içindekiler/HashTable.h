...
#define HASH_TABLE_BASED_SIZE 1000000  // 8-15-24 puzzle için temel hash tablosu boyutu
#define HASH_TABLE_INCREASING_RATE 70  // Hash tablosu boyutunu artýrma oraný
#define MAX_KEY_SIZE 30                // Hash anahtarýnýn maksimum uzunluðu
