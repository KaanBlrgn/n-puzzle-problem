...
#define PUZZLE_SIZE  3 // 3x3'lük puzzle için


// ========  YOUR COMPULSORY (BUT SPECIFIC TO THE PROBLEM) COMMANDS ============
#define PREDETERMINED_GOAL_STATE  1 // Kullanýcý önceden hedef durumu belirleyecekse (1)
#define ACTIONS_NUMBER  4            // Tüm olasý hamle sayýsý (Yukarý, Aþaðý, Sol, Sað)
#define MAX_SEARCHED_NODE 100000000 // Arama sürecinden çýkýþ eþiði
...
void Warning_Memory_Allocation(const char *message); // Hata mesajýný parametre olarak alacak þekilde düzeltildi
